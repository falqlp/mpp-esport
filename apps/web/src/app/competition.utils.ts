...
export const COMPETITIONS: Array<{ value: CompetitionKey; label: 'competition.allSplits' | 'competition.name' }> = [
  ...
  { value: 'FIRST_STAND', label: 'competition.name' },
  { value: 'WORLDS', label: 'competition.name' },
];
